...
def custom_heuristic(file_path):
    ...
    if Pclass > 2 => 66.78%
    if Sex == female => 78.68%
    if passenger['Sex'] == 'female' or (passenger['Age'] < 18 and passenger['Pclass'] < 2) => 79.12%
    if passenger['Sex'] == 'female' or (passenger['Age'] < 18 and passenger['Pclass'] <= 2) => 79.91%
    if passenger['Sex'] == 'female' or (passenger['Age'] < 18 and passenger['Pclass'] <= 2) and (passenger['Embarked'] == 'C' or passenger['Embarked'] == 'S') => 79.91%
    if passenger['Sex'] == 'female' or (passenger['Age'] < 15 and passenger['Pclass'] <= 2) => 80.02%
    '''
